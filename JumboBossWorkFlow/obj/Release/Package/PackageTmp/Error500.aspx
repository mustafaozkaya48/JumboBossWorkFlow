<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Error500.aspx.cs" Inherits="JumboBossWorkFlow.Areas.WorkFlow.WebForm1" %>
    ...
    <div class="outer">
        <div class="middle">
            <div class="inner">
                ...
                <span class="inner-status">Opps! Sunucu Hatası!</span>
                <span class="inner-detail" style="color:#fff;">
                  
Ne yazık ki aradığınız sayfayı yüklemede sorun yaşıyoruz. Lütfen bir süre sonra deneyin.
                </span>
                <!--END CONTENT-->
            </div>
        </div>
